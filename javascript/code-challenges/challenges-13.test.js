...
const findHappiness = (arr) => {
  // Solution code here...
  let arr2 = arr.filter(str => (str.includes(':)')))
  return arr2
};
...
const standardizePhoneNumbers = (arr) => {
  ...
  let arr2 =arr.map(str =>{
    ...
    let substr2 = str.substring(6,9)
    let substr3 = str.substring(10,14)
    let substr = substr1 + substr2 + substr3
    return substr
  })
  return arr2
};
...
const onlyOddChars = (str) => {
  ...
  let oddstrarr = strarr.filter(char=> strarr.indexOf(char) % 2 === 1)
  str2 = oddstrarr.join('')
  //  console.log(str)
  // console.log(str2)
  return str2
