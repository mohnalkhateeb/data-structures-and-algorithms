...
const addPurchases = (arr) => {
  // Solution code here...
  let totalprice = arr.reduce((acc,value,idx)=>{
    value = parseInt(arr[idx].purchasePrice)
    acc=acc+value;
    return acc
  },0)
  return totalprice
...
const returnNames = (arr) => {
  // Solution code here...
    // let arrofnames =[];
   let arrofnames = arr.reduce((arr1,value,idx)=>{
    value = arr[idx].name
    arr1.push(value)
    return arr1
  },[])
...
const reversedString = (str) => {
 ...
 let reversestr = arrchar.reduce((str1,char,idx)=>{
   char = arrchar[arrchar.length-(idx+1)]
   str1=str1+char
   return str1
